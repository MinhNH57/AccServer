...
public class GetDataStoredProcedure : StoredProcedureBase
{
    ...
    public GetDataStoredProcedure(string catalogType, string? ids, string? searchTerm, string? fields,
        List<Filter> filter, List<Sort> sort, int? page, int? pageSize,  string? typeView = null)
