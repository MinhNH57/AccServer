...
public class FAAdjustmentDetailPostEntityTypeConfiguration
    : IEntityTypeConfiguration<FAAdjustmentDetailPost>
{
    public void Configure(EntityTypeBuilder<FAAdjustmentDetailPost> builder)
    {
        builder.ToTable("FAAdjustmentDetailPost");
        ...
        .WithMany(r => r.FAAdjustmentDetailPosts)
        .HasForeignKey("RefId")
        .IsRequired()
