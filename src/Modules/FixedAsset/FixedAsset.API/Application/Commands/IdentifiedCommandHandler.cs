    ...
    public async Task<R> Handle(IdentifiedCommand<T, R> message, CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                switch (command)
                {
                    case CreateFixedAssetCommand createFixedAssetCommand:
                        idProperty = nameof(createFixedAssetCommand.FixedAsset.RefNo);
                        commandId = createFixedAssetCommand.FixedAsset.RefNo;
                        break;
