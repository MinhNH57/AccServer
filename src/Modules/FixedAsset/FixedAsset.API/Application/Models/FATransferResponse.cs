...
public class FATransferAvailableFixedAsset
{
...
public class FATransferDetailDto
{
...
public class FATransferResponse
{
    public List<FATransferDto> FATransfer { get; set; }
    public List<FATransferDetailDto> FATransferDetail { get; set; }
}

public class FATransferCreateResponse
{
    public List<FATransferSaveFullResponse> FATransfer { get; set; }
    public List<FATransferDetailSaveFullResponse> FATransferDetail { get; set; }
}

public class FATransferUpdateResponse
{
    public List<FATransferSaveFullResponse> FATransfer { get; set; } = [];
    public List<FATransferDetailSaveFullResponse> FATransferDetail { get; set; } = [];
}

public class FATransferSaveFullResponse
{
    public Guid RefId { get; set; }
    public int EditVersion { get; set; }
    public Guid BranchId { get; set; }
...
public class FATransferDetailSaveFullResponse
{
    public Guid RefDetailId { get; set; }
    public int SortOrder { get; set; }
}