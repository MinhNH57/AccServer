...
public class CheckExistsFADepreciationQuery
{
    public int Month { get; set; }
    public int Year { get; set; }
}

public class GetFADepreciationDetailQuery
{
...
public class FADepreciationCreateRequest
{
...
public class FADepreciationDetailCreateRequest
{
...
public class FADepreciationDetailAllocationCreateRequest
{
    public Guid? FixedAssetId { get; set; }
    public Guid? OrganizationUnitId { get; set; }
...
public class FADepreciationDetailPostCreateRequest
{
    public Guid? ExpenseItemId { get; set; }
    public Guid? OrganizationUnitId { get; set; }
...
public class FADepreciationUpdateRequest
{
    ...
    public List<AttachmentIdListData> AttachmentIdListData { get; set; } = [];
    public FADepreciationDto OldData { get; set; }
}

public class FADepreciationDetailUpdateRequest
{
    ...
    public int State { get; set; }
    public int EditVersion { get; set; }
    public FADepreciationDetailDto OldData { get; set; }
}

public class FADepreciationDetailAllocationUpdateRequest
{
    public Guid? TenantId { get; set; }
    public Guid RefDetailId { get; set; }
    public Guid? RefId { get; set; }
    ...
    public string DepreciationAccount { get; set; }
    public string OrganizationUnitCode { get; set; }
    public FADepreciationDetailAllocationDto OldData { get; set; }
}

public class FADepreciationDetailPostUpdateRequest
{
    public Guid? TenantId { get; set; }
    public Guid RefDetailId { get; set; }
    public Guid? RefId { get; set; }
    ...
    public int EditVersion { get; set; }
    public int? AllocationObjectType { get; set; }
    public FADepreciationDetailPostDto OldData { get; set; }
}
