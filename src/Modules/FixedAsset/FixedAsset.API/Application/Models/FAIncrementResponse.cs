...
public class FixedAssetDetailAccessoryDto
{
    public Guid FixedAssetDetailId { get; set; }
    public Guid FixedAssetId { get; set; }
    public int SortOrder { get; set; }
...
public class FixedAssetDetailAllocationDto
{
    public Guid FixedAssetDetailId { get; set; }
    public Guid FixedAssetId { get; set; }
...
public class FixedAssetDetailSourceDto
{
    public Guid FixedAssetDetailId { get; set; }
    public Guid FixedAssetId { get; set; }
    public Guid RefId { get; set; }
...
{
    public List<FixedAssetDto> FixedAsset { get; set; }
    public List<FixedAssetDetailAllocationDto> FixedAssetDetailAllocation { get; set; }
    public List<FixedAssetDetailSourceDto> FixedAssetDetailSource { get; set; }
    public List<FixedAssetDetailDto> FixedAssetDetail { get; set; }
    public List<FixedAssetDetailAccessoryDto> FixedAssetDetailAccessory { get; set; }
}

public class FAIncrementCreateResponse
{
    public List<FixedAssetSaveFullResponse> FixedAsset { get; set; }
    public List<FixedAssetDetailSaveFullResponse> FixedAssetDetailAllocation { get; set; }
    public List<FixedAssetDetailSaveFullResponse> FixedAssetDetailSource { get; set; }
    public List<FixedAssetDetailSaveFullResponse> FixedAssetDetail { get; set; }
    public List<FixedAssetDetailSaveFullResponse> FixedAssetDetailAccessory { get; set; }
}

public class FAIncrementUpdateResponse
{
    public List<FixedAssetSaveFullResponse> FixedAsset { get; set; } = [];
    public List<FixedAssetDetailSaveFullResponse> FixedAssetDetailAllocation { get; set; } = [];
    public List<FixedAssetDetailSaveFullResponse> FixedAssetDetailSource { get; set; } = [];
...
public class FixedAssetSaveFullResponse
{
    public Guid? FixedAssetId { get; set; }
    public int EditVersion { get; set; }
    public Guid BranchId { get; set; }
...
public class FixedAssetDetailSaveFullResponse
{
    public Guid? FixedAssetDetailId { get; set; }
    public int SortOrder { get; set; }
}

public class FixedAssetDeleteResponse
{
    public Guid RefId { get; set; }
    public DateTime PostedDate { get; set; }
    public DateTime RefDate { get; set; }
