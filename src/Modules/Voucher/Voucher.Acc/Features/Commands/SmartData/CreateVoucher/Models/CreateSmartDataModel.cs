...
public class CreateSmartDataModel
{
    ...
    public string? AccountingShortcutsCode { get; set; } = string.Empty;
    public string? AccountingShortcutsName { get; set; } = string.Empty;
    public string? CreditSideShortcuts { get; set; } = string.Empty;
    public string? DebitSideShortcuts { get; set; } = string.Empty;
    ...
    public List<CreateSmartContentsDataModel>? SmartContentsDatas { get; set; } = [];

    public List<CreateSmartVatTaxListModel>? SmartVatTaxLists { get; set; } = [];
