...
public class CreateManufactureVoucherCommandHandler(
    VoucherDbContext dbContext,
    IMultiTenantContextAccessor tenantContextAccessor,
    ICurrentUser currentUser)
    : ICommandHandler<CreateManufactureVoucherCommand, Result<bool>>
{
    TenantInfoCustomize? _tenant = tenantContextAccessor.MultiTenantContext.TenantInfo as TenantInfoCustomize;

    public async Task<Result<bool>> Handle(CreateManufactureVoucherCommand request, CancellationToken cancellationToken)
    {
