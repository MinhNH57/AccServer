...
namespace Catalog.Base.Infrastructure.StoredProcedures;

public class FindCatalogStoredProcedure : StoredProcedureBase
{
    ...
    private const string CreatedOnMaxParameterName = "@CreatedOnMax";

    private const string CreatedOnMinParameterName = "@CreatedOnMin";

    private const string ModifiedOnMaxParameterName = "@ModifiedOnMax";
    private const string ModifiedOnMinParameterName = "@ModifiedOnMin";
    ...
    private const string SearchFields = "@SearchFields";
    //private const string CodeUser = "@CodeUser";

    public FindCatalogStoredProcedure(string catalogType, string? ids, string? searchTerm, string? fields,
        List<Filter> filter, List<Sort> sort, int? page, int? pageSize, string? typeView = null, string? codeUser = null, string? searchFields = null)
        : base(FindGridSettingStoredProcedureName)
    {
        ...
        Parameters.Add(SearchFields, searchFields, DbType.String);
