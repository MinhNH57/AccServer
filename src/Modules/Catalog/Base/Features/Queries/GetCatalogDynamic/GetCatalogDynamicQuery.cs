...
namespace Catalog.Base.Features.Queries.GetCatalogDynamic;
...
public class GetDynamicCatalogQueryHandler(CatalogDbContext dbContext, IDistributedCache cache) : IQueryHandler<GetDynamicCatalogQuery, Result<PagedResult<object>>>
{
