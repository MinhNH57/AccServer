...
public class ReportConfigPages
{
    ...
    public bool ShowProductSelected { get; set; }
    ...
    public bool GridSelecteOption { get; set; } 
    public string? NameReportContent { get; set; } 
    public string? WareHouseCodeColumn { get; set; }

    public string? ProductCodeColumn { get; set; }

    public string? AccountSymbolColumn { get; set; }
}
