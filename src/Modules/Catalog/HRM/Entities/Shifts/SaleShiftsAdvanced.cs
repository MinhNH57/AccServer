...
public class SaleShiftsAdvanced
{
    ...
    public DateTime? BeforeTheSpecificTime { get; set; }
    public bool? IsBeforeRequireOvertimeCheckInAndCheckOut { get; set; }
    public DateTime? OverCheckinBegin { get; set; }
    public DateTime? OverCheckOutEnd { get; set; }
    public bool? IsAfterWorkShift { get; set; }
    public bool? IsAfterTheSpecificTime { get; set; }
    public DateTime? AfterTheSpecificTime { get; set; }
    ...
    public bool? IsPaidLeaveForTheEntireShift { get; set; }
    public bool? IsPaidLeaveForThePartShift { get; set; }
    public bool? IsTheEntireShiftOnBusinessTrips { get; set; }
    public bool? IsThePartShiftOnBusinessTrips { get; set; }
}
