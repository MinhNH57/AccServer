...
namespace Catalog.HRM.Entities
{
    public class CatalogObject
    {
        ...
        public string? CodePosition { get; set; } = string.Empty;
        ...
        public float? SalarySafety { get; set; }
        ...
        public string? DateOfIssueCitizen { get; set; }
        public string? PlaceOfIssuance { get; set; }
        public string? PasswordHash { get; set; }
        public string? MaritalStatus { get; set; }
        public string? UnionMember { get; set; }
        public string? NationObj { get; set; }
        public string? ReligionObj { get; set; }
        public string? HeightObj { get; set; }
        public string? WeightObj { get; set; }
        public string? BloodType { get; set; }
        public string? CongenitalDisease { get; set; }
        public string? HealthCondition { get; set; }
        public DateTime? CheckNearest { get; set; }
        public DateTime? StartDateWork { get; set; } // Ngay di lam dau tien
        public string? FormWork { get; set; } // Hinh thuc lam viec
        public float? Seniority { get; set; } // Tham nien
